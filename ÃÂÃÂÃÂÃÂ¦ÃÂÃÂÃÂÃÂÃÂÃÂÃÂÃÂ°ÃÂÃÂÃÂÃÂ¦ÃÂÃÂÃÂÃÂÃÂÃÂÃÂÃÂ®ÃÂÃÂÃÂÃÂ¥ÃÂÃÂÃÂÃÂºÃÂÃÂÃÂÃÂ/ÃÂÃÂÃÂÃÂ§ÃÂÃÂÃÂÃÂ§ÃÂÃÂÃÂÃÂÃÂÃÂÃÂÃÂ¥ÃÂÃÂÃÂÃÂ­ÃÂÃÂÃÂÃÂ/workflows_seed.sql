...
('step_repl_3', 'inst_repl_01', 3, '经营宪章与预算法规合规审计', 'risk_review', 'completed', 'FinanceAgent', '合规验证通过：已校验流控预算，未背离当前季度最大周转预算配额。', NOW() - INTERVAL '47 hours 42 minutes', NOW() - INTERVAL '47 hours 30 minutes'),
